...
socketio.Socket = function() {
    socketio.Socket.base(this, 'constructor');
 ...
 * @const
 */
socketio.Socket.SCRIPT_PATH = '/static/js/socket.io.js';
...
/** @override */
socketio.Socket.prototype.listen = function(type, listener, opt_useCapture, opt_listenerScope) {
    this.setWrapperIfNecessary_(type);
    socketio.Socket.base(this, 'listen', type, listener, opt_useCapture, opt_listenerScope);
};


/** @override */
socketio.Socket.prototype.listenOnce = function(type, listener, opt_useCapture, opt_listenerScope) {
    this.setWrapperIfNecessary_(type);
    socketio.Socket.base(this, 'listenOnce', type, listener, opt_useCapture, opt_listenerScope);
};
...
socketio.Socket.prototype.assertSocketExists_ = function() {
    goog.asserts.assert(goog.isDefAndNotNull(this.socket_), 'This socket is not opened.');
};
...
socketio.Socket.prototype.isOpen = function() {
    return socketio.Socket.imported_ && this.socket_ && this.socket_['socket']['open'];
};
...
socketio.Socket.prototype.importSocketIo = function() {
    ...
    switch (socketio.Socket.state) {
        ...
        case socketio.Socket.State.LOADING:
            ...
            this.handler_.listen(script, goog.events.EventType.LOAD, this.handleScriptLoad_);
            break;
...
socketio.Socket.prototype.onmessage_ = function(msg) {
    this.dispatchEvent({ type: socketio.Socket.EventType.MESSAGE, message: msg });
};
...
socketio.Socket.prototype.disposeInternal = function() {
    socketio.Socket.base(this, 'disposeInternal');
